...
export const config = {
  ...
  ai: {
    provider: process.env.GITFUSION_AI_PROVIDER || 'local',
    baseUrl: process.env.GITFUSION_AI_BASE_URL || 'http://127.0.0.1:11434',
    model: process.env.GITFUSION_AI_MODEL || 'qwen2.5-coder:7b',
    token: process.env.GITFUSION_AI_TOKEN || '',
  },
