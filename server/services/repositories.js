...
import { shouldUseNetwork } from './connectivity.js';
...
export async function importRepos(urls = []) {
  if (!(await shouldUseNetwork())) throw new Error('Modo offline ativo ou rede indisponível. Para importar repositórios do GitHub, mude para Automático ou Online.');
